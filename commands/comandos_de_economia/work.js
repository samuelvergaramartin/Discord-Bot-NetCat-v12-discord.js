...
module.exports = {
    ...
    if(cooldown.has(message.author.id)) return message.channel.send("Espera 30 minutos para volver a usar este comando.")
  ...
  .setTitle("Trabajo")
  .setDescription(`El usuario **${user}** ha trabajado de **${randomTrabajo}** y gano **${random}$**. Además, tu nivel de trabajador ha subido ${working} niveles`)
